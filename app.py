    ...
    messages = [
        {
            ...
            "parts": [
                {"text": (
                    ...
                    "Сделай описание в меру длинным, в милом, но эффектном стиле. Если это девушка — добавь нежности, магии и очарования; если парень — сделай образ дружелюбным, но загадочным. "
