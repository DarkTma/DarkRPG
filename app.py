    ...
    messages = [
        {
            ...
            "parts": [
                {"text": (
                    ...
                    "и улучшает его для генерации аниме-персонажа в стиле магического фэнтези. "
                    "Сделай описание не очень длинным(2-3 приложения), в милом, но эффектном стиле. Если это девушка — добавь нежности, магии и очарования; если парень — сделай образ дружелюбным, но загадочным. "
                    "Добавь аниме-стилистику с магической аурой, свечением, спецэффектами вокруг персонажа (летающие частицы, свет, искры). "
                    "Обязательно сделай фон белым. Избегай тяжелой брони и агрессивных черт. Персонаж — магический воин из исекай или аниме о волшебстве. "
                    "Ответь только улучшенным промтом, без заголовков, форматирования или лишних слов. Просто готовый текст на английском."
                )},
                {"text": user_prompt}
            ]
        }
