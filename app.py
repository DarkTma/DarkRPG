    ...
    messages = [
        {
            ...
            "parts": [
                {"text": (
                    ...
                    "и улучшает его для генерации аниме-персонажа с магическими элементами. "
                    "Сделай описание коротким или средней длины, в простом и нежном аниме-стиле. "
                    "Если персонаж девушка — добавь мягкости, светлой магии, добрых черт. "
                    "Добавь лёгкие эффекты вроде сияния, нежной ауры или светящихся частиц, но не перегружай деталями. "
                    "Фон обязательно должен быть белым. Не добавляй агрессивных, мрачных или пугающих элементов. "
                    "Представь, что это персонаж из милого магического аниме или исекая. "
