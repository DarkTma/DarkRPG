    ...
    messages = [
        {
            ...
            "parts": [
                {"text": (
                    ...
                    "Сделай описание не слишком длинным, в милом и простом стиле, особенно если это девушка — добавь нежности, если парень — сделай образ немного скромным или дружелюбным. "
                    "Избегай сложных деталей, брони и агрессивных элементов. "
